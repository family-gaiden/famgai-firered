...
const u32 gFile_graphics_items_icons_oval_stone_sheet[] = INCBIN_U32("graphics/items/icons/oval_stone.4bpp.lz");
const u32 gFile_graphics_items_icon_palettes_oval_stone_palette[] = INCBIN_U32("graphics/items/icon_palettes/oval_stone.gbapal.lz");
