...
extern const u8 BattleScript_EatStolenBerry[];
...
extern const u8 BattleScript_BerryCurePrlz_Pluck[];
extern const u8 BattleScript_BerryCurePsn_Pluck[];
extern const u8 BattleScript_BerryCureBrn_Pluck[];
extern const u8 BattleScript_BerryCureFrz_Pluck[];
extern const u8 BattleScript_BerryCureSlp_Pluck[];
extern const u8 BattleScript_BerryCureConfusion_Pluck[];
extern const u8 BattleScript_BerryCureChosenStatus_Pluck[];
extern const u8 BattleScript_WhiteHerbEnd2[];
extern const u8 BattleScript_WhiteHerbRet[];
extern const u8 BattleScript_TestString[];
extern const u8 BattleScript_ResetLastUsedItem[];
extern const u8 BattleScript_ItemHealHP_RemoveItem[];
extern const u8 BattleScript_Pluck_NoEffect[];
extern const u8 BattleScript_Pluck_PPHeal[];
extern const u8 BattleScript_ItemHealHP_RemoveItem_Pluck[];
...
extern const u8 BattleScript_BerryConfuseHeal_Pluck[];
extern const u8 BattleScript_BerryStatRaiseEnd2[];
extern const u8 BattleScript_BerryStatRaise_Pluck[];
extern const u8 BattleScript_BerryFocusEnergyEnd2[];
extern const u8 BattleScript_BerryFocusEnergy_Pluck[];
